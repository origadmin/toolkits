...
const (
	...
	ginsPackage    = protogen.GoImportPath("github.com/origadmin/contrib/transport/gins")
...
func generateFile(gen *protogen.Plugin, file *protogen.File, omitempty bool, omitemptyPrefix string) *protogen.GeneratedFile {
	...
	filename := file.GeneratedFilenamePrefix + "_ginrpc.pb.go"
	g := gen.NewGeneratedFile(filename, file.GoImportPath)
	g.P("// Code generated by protoc-gen-go-ginrpc. DO NOT EDIT.")
	g.P("// versions:")
	g.P(fmt.Sprintf("// - protoc-gen-go-ginrpc %s", version))
...
func generateFileContent(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile, omitempty bool, omitemptyPrefix string) {
	...
	g.P("const _ = ", ginsPackage.Ident("SupportPackageIsVersion1"))
	g.P()
