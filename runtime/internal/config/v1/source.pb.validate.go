...
// Validate checks the field values on SourceConfig_Custom with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *SourceConfig_Custom) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on SourceConfig_Custom with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// SourceConfig_CustomMultiError, or nil if none found.
func (m *SourceConfig_Custom) ValidateAll() error {
	return m.validate(true)
}

func (m *SourceConfig_Custom) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, SourceConfig_CustomValidationError{
					field:  "Config",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return SourceConfig_CustomValidationError{
				field:  "Config",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return SourceConfig_CustomMultiError(errors)
	}

	return nil
}

// SourceConfig_CustomMultiError is an error wrapping multiple validation
// errors returned by SourceConfig_Custom.ValidateAll() if the designated
// constraints aren't met.
type SourceConfig_CustomMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m SourceConfig_CustomMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m SourceConfig_CustomMultiError) AllErrors() []error { return m }

// SourceConfig_CustomValidationError is the validation error returned by
// SourceConfig_Custom.Validate if the designated constraints aren't met.
type SourceConfig_CustomValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e SourceConfig_CustomValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e SourceConfig_CustomValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e SourceConfig_CustomValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e SourceConfig_CustomValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e SourceConfig_CustomValidationError) ErrorName() string {
	return "SourceConfig_CustomValidationError"
}

// Error satisfies the builtin error interface
func (e SourceConfig_CustomValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sSourceConfig_Custom.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = SourceConfig_CustomValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = SourceConfig_CustomValidationError{}
