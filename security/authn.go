...
type Authenticator interface {
	...
	AuthenticateTokenContext(context.Context, ContextType) (Claims, error)
	...
	AuthenticateContext(context.Context, ContextType, string) (bool, error)
	...
	CreateTokenContext(context.Context, ContextType, Claims) (context.Context, error)
	...
	DestroyTokenContext(context.Context, ContextType, string) error
